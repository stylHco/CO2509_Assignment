...
// this page is very similar with the movies page and the peruse
// is to search and display tv series
...
class _TvSeriesPageState extends State<TvSeriesPage> {
  ...
  Future <void> progressOfFetchData() async{
    ...
    getData(tvSeriesList,"$tvSearchURL?query=$searchedQuery");
            ...
            Flexible(
              child: ListView(
                ...
                children: [
                  if (showInitialMessage)
                    ...
                    Center(child: CircularProgressIndicator())
                  ...
                  else if (!dataIsLoading && tvSeriesList.isEmpty)
                      Center(child: Text(
                      ...
                      TvSeriesList(itemList: tvSeriesList),
                  const SizedBox(height: 25),
                ],
              ),
            ),
          ...
          child: Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  MoreInfoPage(inputId: item['id'], inputType: "tv",)),
                );
              },
              child: Row(
